...
#end
//import HealthBarColor.dominantColor;
...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		*/
		if (FileSystem.exists(Paths.txt(SONG.song.toLowerCase() + '/dialogue')))
		{
			dialogue = CoolUtil.coolTextFile(Paths.txt(SONG.song.toLowerCase() + '/dialogue'));
		}
		...
		healthBarBG = new FlxSprite(0, FlxG.height * 0.9 - 15).loadGraphic(Paths.image('healthBar'));
	...
	function startSong():Void
	{
		...
		songCard.forEach(function(spr:FlxSprite)
		{
			...
			FlxTween.tween(spr, {x: (FlxG.width - spr.width) - 20}, 1.2, {ease: FlxEase.circOut, onComplete:
	...
	override public function update(elapsed:Float)
	{
		...
		scoreTxt.text = "Score: " + songScore + " | Misses: " + misses + " | Accuracy: " + truncateFloat(accuracy, 2) + "% | Rank: " + Ratings.GenerateLetterRank(accuracy, false);
