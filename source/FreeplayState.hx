...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("Freeplay (Choosing Song)", null);
		#end
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.pressed.L)
		{
			...
			nowPlaying = new FlxText(weekPlay.x, weekPlay.y + 15 * 2, 0, "", 15);
			nowPlaying.font = scoreText.font;
			
			add(nowPlaying);
			
			nowPlaying.text = "Now Playing: " + songs[curSelected].songName;
		}
	...
	function changeSelection(change:Int = 0)
	{
		...
		weekPlay.font = scoreText.font;
		weekPlay.text = "Week: " + songs[curSelected].week;
